...
> **[2026-07-23 갱신 — 현 스코프에선 사용 안 함]** 로컬 우선 스코프 확정으로 클라우드 워커는
> 배포하지 않는다(정본: [local-first-design.md](local-first-design.md)). 24h 상주를 다시
> 최우선으로 올릴 때만 이 절차로 복귀한다. 아래 내용은 그 시점을 위한 보존 문서.
>
