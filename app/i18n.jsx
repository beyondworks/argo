...
const DICT = {
  ...
  'settings.runners.cliToolsNote': ['크루가 스스로 거는 쪽지·루틴 예약: 지원. 동기 위임·결재·도구 설치·장시간 작업은 SDK 러너(Claude·GLM·Kimi·OpenRouter·Grok) 전용입니다.', 'Crew-initiated mail and routine scheduling: supported. Synchronous delegation, approvals, tool installs and long-running jobs are SDK-runner only (Claude·GLM·Kimi·OpenRouter·Grok).'],
