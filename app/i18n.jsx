...
const DICT = {
  ...
  'settings.workroots.runnerNote': ['Claude·GLM·Kimi 크루는 도구 게이트로, Codex 크루는 샌드박스 허용 목록으로 적용됩니다. Gemini 계열은 경로 제어가 없어 안내로만 전달됩니다. Argo 앱·자격 폴더는 지정과 무관하게 항상 보호됩니다.', 'Applies via the tool gate for Claude·GLM·Kimi crews and the sandbox allow-list for Codex crews. Gemini-family runners have no path control, so folders are conveyed as guidance only. The Argo app and credential folders stay protected regardless.'],
