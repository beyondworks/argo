...
const DICT = {
  ...
  'settings.runners.cliToolsNote': ['크루가 스스로 거는 쪽지·루틴 예약: 지원. 동기 위임·결재·도구 설치·장시간 작업은 SDK 러너(Claude·GLM·Kimi·OpenRouter) 전용입니다.', 'Crew-initiated mail and routine scheduling: supported. Synchronous delegation, approvals, tool installs and long-running jobs are SDK-runner only (Claude·GLM·Kimi·OpenRouter).'],
  ...
  'market.mcpRunnerNote': ['CLI 러너(Codex·Gemini·Antigravity) 크루는 아직 MCP를 쓸 수 없습니다 — SDK 러너(Claude·GLM·Kimi·OpenRouter) 크루에서 사용됩니다. 러너 무관 지원이 예정돼 있습니다.', 'Crews on CLI runners (Codex·Gemini·Antigravity) cannot use MCP yet — it runs on SDK-runner crews (Claude·GLM·Kimi·OpenRouter). Runner-agnostic support is planned.'],
