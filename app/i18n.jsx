...
const DICT = {
  ...
  'settings.export.note': ['보안을 위해 자격·연결 파일(러너 키, 메신저 봇 토큰, MCP 토큰)은 내보내지 않습니다. 앱은 계속 원래 위치의 데이터를 사용합니다 — 내보낸 사본은 보관용입니다.', 'For security, credential and connection files (runner keys, messenger bot tokens, MCP tokens) are not exported. The app keeps using the original data — the exported copy is for safekeeping.'],
