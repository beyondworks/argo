...
const DICT = {
  ...
  'runner.effortAutoHint': ['추론 강도 — Claude·Codex로 실행될 때 적용됩니다(Antigravity는 모델 선택에 강도가 포함 · Gemini·GLM·Kimi·OpenRouter·Qwen 3.6 27B는 미지원)', 'Reasoning effort — applies on Claude and Codex (Antigravity bakes effort into model choice; not supported on Gemini, GLM, Kimi, OpenRouter, Qwen 3.6 27B)'],
  ...
  'settings.workroots.runnerNote': ['Claude·GLM·Kimi 크루는 도구 게이트가 폴더 단위로 적용하고, Argo 앱·자격 폴더는 항상 차단합니다. Codex 크루는 프로세스 단위 샌드박스라 넓은 폴더(예: 홈 전체)를 지정하면 그 안의 보호 폴더까지 함께 열릴 수 있습니다 — 필요한 폴더만 좁게 지정하세요. Gemini 계열은 경로 제어가 없어 안내로만 전달됩니다.', 'For Claude·GLM·Kimi crews the tool gate applies per folder and always blocks the Argo app and credential folders. Codex crews run in a process-level sandbox — assigning a broad folder (e.g. your whole home) can open protected folders inside it too, so assign only the folders you need. Gemini-family runners have no path control; folders are conveyed as guidance only.'],
  ...
  'settings.runners.deepseeklocalHelp': ['OpenAI 호환 서버의 Base URL과 API 키를 입력하세요. 예: http://100.103.65.62:8080/v1. llamacpp·vLLM 등 로컬 서버에 연결합니다.', 'Enter the Base URL and API key for the OpenAI-compatible server. Example: http://100.103.65.62:8080/v1. Connects to local servers such as llamacpp or vLLM.'],
  'settings.runners.deepseeklocalPh': ['Base URL 입력 (예: http://100.103.65.62:8080/v1)', 'Base URL (e.g. http://100.103.65.62:8080/v1)'],
  'settings.runners.deepseeklocalBaseLabel': ['Base URL', 'Base URL'],
  'settings.runners.deepseeklocalApiKeyLabel': ['API 키', 'API key'],
  ...
  'settings.runners.cliToolsNote': ['크루가 스스로 거는 쪽지·루틴 예약·위임 도구: 미지원 (외부 CLI 및 OpenAI 호환 러너 등)', 'Crew-initiated mail, routine scheduling & delegation tools: not supported (external CLI or OpenAI-compat runners)'],
  ...
  'billing.upgradeMonthly': ['Pro 업그레이드 — $16/월', 'Upgrade to Pro — $16/mo'],
  'billing.upgradeYearly': ['연간 $160 (2개월 무료)', 'Yearly $160 (2 months free)'],
  ...
  'crew.panel.shortcut': ['Ctrl+Alt+B', 'Ctrl+Alt+B'],
  ...
  'crew.tools.title': ['도구 작업영역', 'Tool workspace'],
  'crew.tools.open': ['도구 열기', 'Open tool'],
  'crew.tools.closeTab': ['{name} 탭 닫기', 'Close {name} tab'],
  'crew.tools.files': ['파일', 'Files'],
  'crew.tools.terminal': ['터미널', 'Terminal'],
  'crew.tools.browser': ['브라우저', 'Browser'],
  'crew.tools.files.desc': ['프로젝트 트리에서 문서 열기', 'Open documents from the project tree'],
  'crew.tools.terminal.desc': ['현재 프로젝트에서 셸 실행', 'Run a shell in the current project'],
  'crew.tools.browser.desc': ['웹 또는 로컬 앱 열기', 'Open the web or a local app'],
  'crew.tools.empty': ['열 도구를 선택하세요', 'Choose a tool to open'],
  'crew.tools.refresh': ['새로고침', 'Refresh'],
  'crew.tools.resizePanel': ['사이드 패널 폭 조절', 'Resize side panel'],
  'crew.tools.settings': ['설정 열기', 'Open settings'],
  'crew.tools.files.root': ['작업 폴더', 'Workspace root'],
  'crew.tools.files.filter': ['파일 필터링…', 'Filter files…'],
  'crew.tools.files.searching': ['찾는 중', 'Searching'],
  'crew.tools.files.noMatch': ['일치하는 파일이 없습니다', 'No matching files'],
  'crew.tools.files.connect': ['외부 작업 폴더 연결', 'Connect an external work folder'],
  'crew.tools.files.pick': ['파일을 선택해서 여세요', 'Select a file to open it'],
  'crew.tools.files.openFiles': ['열린 파일', 'Open files'],
  'crew.tools.files.closeFile': ['{name} 파일 닫기', 'Close {name}'],
  'crew.tools.files.location': ['파일 위치', 'File location'],
  'crew.tools.files.reload': ['파일 다시 열기', 'Reload file'],
  'crew.tools.files.download': ['파일 다운로드', 'Download file'],
  'crew.tools.files.editor': ['Markdown 편집기', 'Markdown editor'],
  'crew.tools.files.preview': ['미리보기', 'Preview'],
  'crew.tools.files.saving': ['저장 중…', 'Saving…'],
  'crew.tools.files.unsaved': ['저장하지 않은 변경 사항', 'Unsaved changes'],
  'crew.tools.files.discardConfirm': ['저장하지 않은 변경 사항을 버릴까요?', 'Discard unsaved changes?'],
  'crew.tools.files.changed': ['파일이 외부에서 변경되었습니다. 다시 연 뒤 수정해 주세요.', 'The file changed outside Argo. Reload it before editing again.'],
  'crew.tools.files.saveFailed': ['파일을 저장하지 못했습니다', 'Could not save the file'],
  'crew.tools.files.tooLarge': ['이 파일은 앱에서 열 수 있는 크기를 넘습니다', 'This file is too large to open in the app'],
  'crew.tools.files.binary': ['이 파일 형식은 앱에서 열 수 없습니다', 'This file type cannot be opened in the app'],
  'crew.tools.files.resize': ['파일 트리 폭 조절', 'Resize file tree'],
  'crew.tools.terminal.cwd': ['터미널 작업 폴더', 'Terminal working directory'],
  'crew.tools.terminal.starting': ['터미널을 시작하는 중…', 'Starting terminal…'],
  'crew.tools.terminal.restart': ['터미널 다시 시작', 'Restart terminal'],
  'crew.tools.terminal.output': ['터미널 출력', 'Terminal output'],
  'crew.tools.terminal.disabled': ['셸 권한이 꺼져 있습니다', 'Shell capability is disabled'],
  'crew.tools.terminal.exited': ['터미널이 종료되었습니다. 다시 시작을 누르세요.', 'Terminal exited. Press restart.'],
  'crew.tools.terminal.placeholder': ['명령을 입력하세요', 'Enter a command'],
  'crew.tools.terminal.run': ['실행', 'Run'],
  'crew.tools.terminal.note': ['일반 셸 명령과 장기 실행 출력에 적합합니다. 전체화면 TUI는 지원하지 않습니다.', 'Supports normal shell commands and long-running output. Full-screen TUIs are not supported.'],
  'crew.tools.browser.back': ['뒤로', 'Back'],
  'crew.tools.browser.forward': ['앞으로', 'Forward'],
  'crew.tools.browser.address': ['주소 또는 검색어', 'Address or search'],
  'crew.tools.browser.placeholder': ['주소 또는 검색어 입력', 'Enter an address or search'],
  'crew.tools.browser.external': ['외부 브라우저에서 열기', 'Open in external browser'],
  'crew.tools.browser.frame': ['내장 브라우저', 'Embedded browser'],
  'crew.tools.browser.note': ['사이트가 내장 표시를 막는 경우 오른쪽 위 외부 열기 버튼을 사용하세요.', 'If a site blocks embedded viewing, use the external-open button above.'],
