...
const DICT = {
  ...
  'compete.pick': ['시안을 받을 크루 (2~3명)', 'Crews to compete (2–3)'],
  'compete.costNote': ['크루 {n}명이 동시에 실행됩니다 — 비용도 약 {n}배입니다.', 'Runs {n} crews at once — cost is roughly {n}×.'],
  ...
  'compete.emptyMain': ['같은 과제를 크루 2~3명에게 동시에 맡기고, 시안을 나란히 비교해 채택하세요. 경쟁 중 시안은 크루 대화를 어지럽히지 않고, 채택본만 기록으로 남습니다.', 'Give one brief to 2–3 crews at once, compare drafts side by side, adopt the best. Only the adopted draft enters the crew\'s thread.'],
  'compete.sessions.title': ['경쟁 기록', 'Contests'],
  'compete.sessions.empty': ['아직 경쟁이 없습니다.', 'No contests yet.'],
  'compete.sessions.newSub': ['과제 하나, 시안 여러 개', 'One brief, several drafts'],
