...
const DICT = {
  // ── 로컬 자산 가져오기
  'localImport.openTools': ['스킬·도구에서 연결 확인', 'Review connections in Skills & Tools'],
  'localImport.reason.dependency-failed': ['이 직원에 연결할 도구나 기억이 처리되지 않았습니다. 해당 항목을 먼저 확인하세요.', 'A tool or memory for this employee was not processed. Review those assets first.'],
  'localImport.selectAll': ['복사 가능한 항목 모두 선택 (기억·충돌·설정 필요 항목 제외)', 'Select all ready assets (excludes memory, conflicts, and setup required)'],
  'localImport.reason.secret-material': ['민감한 내용이 포함되어 일반 자료로 복사할 수 없습니다.', 'Sensitive content prevents copying this as an ordinary asset.'],
  'localImport.error.secret-material': ['민감한 내용이 포함되어 일반 자료로 복사할 수 없습니다.', 'Sensitive content prevents copying this as an ordinary asset.'],
  'localImport.reason.not-selected': ['선택하지 않은 항목입니다.', 'This asset was not selected.'],
  'localImport.reason.invalid-format': ["설정 파일 형식을 읽을 수 없습니다.", "Cannot read this configuration format."],
  'localImport.reason.unsupported-option': ["지원하지 않는 옵션이 있어 자동 연결하지 않습니다.", "Unsupported options prevent automatic activation."],
  'localImport.reason.disabled': ["원본에서 비활성화된 도구입니다.", "This tool is disabled in the source."],
  'localImport.reason.unresolved-reference': ["환경변수 또는 외부 참조를 직접 설정해야 합니다.", "Environment variables or external references require setup."],
  'localImport.reason.invalid-transport': ["지원하는 연결 형식이 아닙니다.", "Unsupported connection transport."],
  'localImport.reason.external-root': ["추가 폴더 접근 승인이 필요합니다.", "Additional folder approval is required."],
  'localImport.reason.protected-root': ["보호된 폴더는 가져올 수 없습니다.", "Protected folders cannot be imported."],
  'localImport.reason.excluded-files': ["제외된 파일이 있어 전체 패키지를 복사하지 않았습니다.", "Excluded files prevent copying a complete package."],
  'localImport.reason.scan-limit': ["탐색 한도를 초과했습니다.", "The scan limit was exceeded."],
  'localImport.reason.package-limit': ["패키지 크기 한도를 초과했습니다.", "The package size limit was exceeded."],
  'localImport.reason.text-limit': ["텍스트 크기 한도를 초과했습니다.", "The text size limit was exceeded."],
  'localImport.reason.config-limit': ["설정 파일 크기 한도를 초과했습니다.", "The configuration size limit was exceeded."],
  'localImport.reason.unsafe-path': ["안전하게 읽을 수 없는 경로입니다.", "This path cannot be read safely."],
  'localImport.reason.source-changed': ["원본이 변경되었습니다. 다시 찾아 선택하고 동의하세요.", "The source changed. Scan again, select, and consent."],
  'localImport.reason.invalid-roots': ["승인 폴더 목록이 바뀌었습니다. 다시 찾은 뒤 승인하세요.", "The approval list changed. Scan again, then approve."],
  'localImport.reason.broken-link': ["대상이 사라진 링크가 있어 그 항목은 건너뛰었습니다.", "A link points to a missing target; that entry was skipped."],
  'localImport.reason.source-unreadable': ["원본을 읽을 수 없습니다. 접근 권한을 확인하세요.", "Cannot read the source. Check access permissions."],
  'localImport.reason.reference-only': ["비활성 참고 자료로 보관합니다. 상시 지시로 적용하지 않습니다.", "Stored as an inactive reference, not as standing instructions."],
  'localImport.reason.target-deleted': ["이전에 복사한 항목이 삭제되어 자동 복구하지 않습니다.", "The previous copy was deleted and will not be recreated automatically."],
  'localImport.reason.target-changed': ["이전에 복사한 항목이 수정되어 덮어쓰지 않습니다.", "The previous copy was edited and will not be overwritten."],
  'localImport.reason.conflict': ["같은 이름이 있어 건너뛰었습니다. 새 이름을 선택하려면 다시 찾으세요.", "Skipped because the name exists. Scan again to choose a new name."],
  'localImport.reason.tools-consent': ["회사 공용 도구 복사에 동의가 필요합니다.", "Consent to company-shared tools is required."],
  'localImport.reason.memory-consent': ["회사 기억 공유와 동기화에 동의가 필요합니다.", "Consent to shared company memory and sync is required."],
  'localImport.reason.secrets-consent': ["민감 설정 복사에 별도 동의가 필요합니다.", "Separate consent for sensitive settings is required."],
  'localImport.reason.write-failed': ["파일을 저장하지 못했습니다. 접근 권한을 확인하고 재시도하세요.", "Could not save the asset. Check permissions and retry."],
  'localImport.reason.scan-expired': ["검토가 만료되었습니다. 다시 찾아 선택하세요.", "This review expired. Scan again and select assets."],
  'localImport.reason.selection-changed': ["선택이 변경되었습니다. 다시 찾아 동의하세요.", "The selection changed. Scan again and consent."],
  'localImport.reason.invalid-selection': ["선택한 항목을 찾을 수 없습니다. 다시 찾으세요.", "Selected assets could not be found. Scan again."],
  'localImport.reason.invalid-name': ["새 이름을 확인하세요.", "Check the new name."],
  'localImport.reason.busy': ["다른 가져오기가 진행 중입니다. 잠시 후 다시 시도하세요.", "Another import is running. Try again shortly."],
  'localImport.error.invalid-format': ["설정 파일 형식을 읽을 수 없습니다.", "Cannot read this configuration format."],
  'localImport.error.unsupported-option': ["지원하지 않는 옵션이 있어 자동 연결하지 않습니다.", "Unsupported options prevent automatic activation."],
  'localImport.error.disabled': ["원본에서 비활성화된 도구입니다.", "This tool is disabled in the source."],
  'localImport.error.unresolved-reference': ["환경변수 또는 외부 참조를 직접 설정해야 합니다.", "Environment variables or external references require setup."],
  'localImport.error.invalid-transport': ["지원하는 연결 형식이 아닙니다.", "Unsupported connection transport."],
  'localImport.error.external-root': ["추가 폴더 접근 승인이 필요합니다.", "Additional folder approval is required."],
  'localImport.error.protected-root': ["보호된 폴더는 가져올 수 없습니다.", "Protected folders cannot be imported."],
  'localImport.error.excluded-files': ["제외된 파일이 있어 전체 패키지를 복사하지 않았습니다.", "Excluded files prevent copying a complete package."],
  'localImport.error.scan-limit': ["탐색 한도를 초과했습니다.", "The scan limit was exceeded."],
  'localImport.error.package-limit': ["패키지 크기 한도를 초과했습니다.", "The package size limit was exceeded."],
  'localImport.error.text-limit': ["텍스트 크기 한도를 초과했습니다.", "The text size limit was exceeded."],
  'localImport.error.config-limit': ["설정 파일 크기 한도를 초과했습니다.", "The configuration size limit was exceeded."],
  'localImport.error.unsafe-path': ["안전하게 읽을 수 없는 경로입니다.", "This path cannot be read safely."],
  'localImport.error.source-changed': ["원본이 변경되었습니다. 다시 찾아 선택하고 동의하세요.", "The source changed. Scan again, select, and consent."],
  'localImport.error.invalid-roots': ["승인 폴더 목록이 바뀌었습니다. 다시 찾은 뒤 승인하세요.", "The approval list changed. Scan again, then approve."],
  'localImport.error.broken-link': ["대상이 사라진 링크가 있어 그 항목은 건너뛰었습니다.", "A link points to a missing target; that entry was skipped."],
  'localImport.error.source-unreadable': ["원본을 읽을 수 없습니다. 접근 권한을 확인하세요.", "Cannot read the source. Check access permissions."],
  'localImport.error.reference-only': ["비활성 참고 자료로 보관합니다. 상시 지시로 적용하지 않습니다.", "Stored as an inactive reference, not as standing instructions."],
  'localImport.error.target-deleted': ["이전에 복사한 항목이 삭제되어 자동 복구하지 않습니다.", "The previous copy was deleted and will not be recreated automatically."],
  'localImport.error.target-changed': ["이전에 복사한 항목이 수정되어 덮어쓰지 않습니다.", "The previous copy was edited and will not be overwritten."],
  'localImport.error.conflict': ["같은 이름이 있어 건너뛰었습니다. 새 이름을 선택하려면 다시 찾으세요.", "Skipped because the name exists. Scan again to choose a new name."],
  'localImport.error.tools-consent': ["회사 공용 도구 복사에 동의가 필요합니다.", "Consent to company-shared tools is required."],
  'localImport.error.memory-consent': ["회사 기억 공유와 동기화에 동의가 필요합니다.", "Consent to shared company memory and sync is required."],
  'localImport.error.secrets-consent': ["민감 설정 복사에 별도 동의가 필요합니다.", "Separate consent for sensitive settings is required."],
  'localImport.error.write-failed': ["파일을 저장하지 못했습니다. 접근 권한을 확인하고 재시도하세요.", "Could not save the asset. Check permissions and retry."],
  'localImport.error.scan-expired': ["검토가 만료되었습니다. 다시 찾아 선택하세요.", "This review expired. Scan again and select assets."],
  'localImport.error.selection-changed': ["선택이 변경되었습니다. 다시 찾아 동의하세요.", "The selection changed. Scan again and consent."],
  'localImport.error.invalid-selection': ["선택한 항목을 찾을 수 없습니다. 다시 찾으세요.", "Selected assets could not be found. Scan again."],
  'localImport.error.invalid-name': ["새 이름을 확인하세요.", "Check the new name."],
  'localImport.error.busy': ["다른 가져오기가 진행 중입니다. 잠시 후 다시 시도하세요.", "Another import is running. Try again shortly."],
  'localImport.title': ["Hermes·OpenClaw 데이터 가져오기", "Import Hermes & OpenClaw data"],
  'localImport.offer': ["이 기기의 Hermes·OpenClaw에서 직원 프로필·스킬·도구 설정·기억을 새 회사로 가져올 수 있습니다. Claude·Codex의 스킬과 도구 설정도 지원합니다.", "Bring employee profiles, skills, tool settings, and memories from Hermes or OpenClaw on this device into your new company. Claude and Codex skills and tool settings are also supported."],
  'localImport.optIn': ["회사 생성 후 가져올 항목 선택하기", "Choose assets after creating the company"],
  'localImport.optional': ["선택 사항입니다. 나중에 회사 설정에서도 시작할 수 있습니다.", "Optional. You can also start later in company settings."],
  'localImport.discovered': ["가져오기 후보 {n}개를 찾았습니다. 추가 폴더는 검토 화면에서 승인할 수 있습니다.", "Found {n} candidate assets. You can approve additional folders during review."],
  'localImport.loading': ["불러오는 중…", "Loading…"],
  'localImport.description': ["이 기기의 Hermes·OpenClaw에서 직원 프로필·스킬·도구 설정·기억을 찾아 선택한 항목을 복사합니다. Claude·Codex의 스킬과 도구 설정도 지원합니다. 원본과 기존 회사 자료는 덮어쓰지 않습니다. 민감한 도구 설정은 별도 동의가 필요하며, 가져오기만으로 도구 실행이나 연결 성공을 확인하지는 않습니다.", "Find and copy selected employee profiles, skills, tool settings, and memories from Hermes or OpenClaw on this device. Claude and Codex skills and tool settings are also supported. Originals and existing company data are not overwritten. Sensitive tool settings require separate consent; importing does not execute tools or verify their connections."],
  'localImport.company': ["가져올 회사: {name}", "Destination company: {name}"],
  'localImport.roots': ["추가 폴더 접근 승인", "Approve additional folders"],
  'localImport.rootsSelectAll': ["폴더 모두 선택", "Select all folders"],
  'localImport.count': ["{n}개", "{n} items"],
  'localImport.rootsHelp': ["체크한 폴더만 읽도록 허용합니다. 승인 후 다시 찾기를 누르세요.", "Allow reading only the checked folders. Then scan again."],
  'localImport.empty': ["가져올 항목이 없습니다. 추가 폴더 승인이나 접근 권한을 확인하세요.", "No assets found. Check additional folder approvals and access permissions."],
  'localImport.size': ["파일 {n}개 · {kb} KB", "{n} files · {kb} KB"],
  'localImport.memoryScope': ["이 기억은 회사 공용 기억으로 복사됩니다.", "This memory will be copied into shared company memory."],
  'localImport.secretFlag': ["민감한 연결 설정 포함 — 별도 동의 필요", "Contains sensitive connection settings — separate consent required"],
  'localImport.conflict': ["같은 이름이 이미 있습니다.", "This name already exists."],
  'localImport.skip': ["건너뛰기 (기본)", "Skip (default)"],
  'localImport.rename': ["새 이름으로 복사", "Copy with a new name"],
  'localImport.newName': ["새 이름", "New name"],
  'localImport.consent': ["선택 항목의 적용 범위 확인", "Confirm the scope of selected assets"],
  'localImport.consent.tools': ["선택한 스킬·도구를 회사 공용으로 복사하는 데 동의합니다. 기존 크루도 접근할 수 있으며, 나중에 사용할 때 스킬 스크립트나 MCP가 코드를 실행할 수 있습니다.", "I agree to copy selected skills and tools into company-shared storage, accessible to existing crew. Skill scripts and MCP servers may execute code when used later."],
  'localImport.consent.memory': ["선택한 기억을 이 회사의 다른 크루도 읽을 수 있고, 기존 동기화 정책을 따름에 동의합니다.", "I agree that other crew in this company can read selected memories and that existing sync policies apply."],
  'localImport.consent.secrets': ["선택한 도구의 민감 설정 복사에 동의합니다. 로컬 암호화를 제공하지 않으며 기존 도구 설정의 저장·동기화 보호를 따릅니다.", "I agree to copy sensitive tool settings. This does not provide local encryption; existing tool storage and sync protection applies."],
  'localImport.resultsHelp': ["항목별 결과를 확인하세요. 실패한 항목만 선택해 재시도할 수 있습니다. 추가 설정이 필요한 도구는 스킬·도구 화면에서 연결을 확인하세요.", "Review each result. Select failed items to retry. Check connections for tools needing setup in Skills & Tools."],
  'localImport.scan': ["이 기기에서 찾기", "Scan this device"],
  'localImport.rescan': ["다시 찾기 · 선택 초기화", "Scan again · reset selection"],
  'localImport.import': ["선택한 {n}개 가져오기", "Import {n} selected"],
  'localImport.retry': ["선택한 {n}개 재시도", "Retry {n} selected"],
  'localImport.continue': ["회사로 계속", "Continue to company"],
  'localImport.later': ["나중에 · 회사로 계속", "Later · continue to company"],
  'localImport.phase.idle': ["항목을 찾고 복사할 내용을 선택하세요.", "Scan and choose what to copy."],
  'localImport.phase.reviewing': ["복사할 항목과 동의를 확인하세요.", "Review selected assets and consents."],
  'localImport.phase.importing': ["중단된 가져오기 상태입니다. 항목을 확인하고 다시 시도하세요.", "An import was interrupted. Review items and retry."],
  'localImport.phase.completed': ["가져오기 처리 결과", "Import results"],
  'localImport.phase.partial': ["일부 항목은 처리되지 않았습니다. 사유를 확인하세요.", "Some assets were not processed. Review the reasons below."],
  'localImport.source.claude': ["Claude", "Claude"],
  'localImport.source.codex': ["Codex", "Codex"],
  'localImport.source.agents': ["공용 에이전트", "Shared agents"],
  'localImport.source.hermes': ["Hermes", "Hermes"],
  'localImport.source.openclaw': ["OpenClaw", "OpenClaw"],
  'localImport.kind.skill': ["스킬", "Skill"],
  'localImport.kind.mcp': ["연결 도구", "Connected tool"],
  'localImport.kind.profile': ["직원 프로필", "Employee profile"],
  'localImport.kind.memory': ["기억", "Memory"],
  'localImport.kind.rule': ["비활성 참고 규칙", "Inactive reference rule"],
  'localImport.compatibility.available': ["복사 가능", "Ready to copy"],
  'localImport.compatibility.needs-setup': ["추가 설정 필요", "Needs setup"],
  'localImport.status.imported': ["복사됨", "Imported"],
  'localImport.status.needs-setup': ["추가 설정 필요", "Needs setup"],
  'localImport.status.skipped': ["건너뜀", "Skipped"],
  'localImport.status.failed': ["실패 · 재시도 가능", "Failed · retry available"],
  'localImport.status.planned': ["복사 대기", "Copy pending"],
  'localImport.status.staged': ["복사 복구 대기", "Copy recovery pending"],
  'localImport.error.unavailable': ["로컬 실행 환경에서만 사용할 수 있습니다. 이 기기의 Argo 앱에서 다시 열어주세요.", "Available only in a supported local runtime. Open Argo on this device."],
  'localImport.error.auth': ["로그인 상태를 확인한 뒤 다시 열어주세요.", "Check your sign-in status and reopen this page."],
  'localImport.error.forbidden': ["이 회사의 가져오기에 접근할 수 없습니다. 계정과 기기를 확인하세요.", "Cannot access imports for this company. Check your account and device."],
  'localImport.error.origin': ["현재 접속 경로에서는 로컬 파일에 접근할 수 없습니다.", "This connection is not allowed to access local files."],
  'localImport.error.invalid': ["요청이 유효하지 않습니다. 항목을 다시 찾아 선택하세요.", "Invalid request. Scan again and select your assets."],
  'localImport.error.internal': ["가져오기 요청을 처리하지 못했습니다. 다시 시도하세요.", "Could not process the import request. Try again."],
  'localImport.reason.other': ["안전하게 자동 변환할 수 없습니다. 설정과 접근 권한을 확인하세요.", "Cannot convert automatically. Check configuration and access permissions."],
  ...
  // 동시 발언 카드·반응 라운드(유건 결정 2026-09-06). 토글은 입력창 아래 줄 — 기본 켜짐, "1라운드만"은 빠른 의견 수집용.
  'room.roundsOn': ['반응 라운드 켜짐', 'Reaction round on'],
  'room.roundsOff': ['1라운드만', 'One round only'],
  'room.roundsHint': ['전원이 서로의 발언을 읽고 한 번 더 답합니다 — 턴 비용이 두 배', 'Everyone reads the others and replies once more — doubles turn cost'],
  'room.round2': ['반응', 'reaction'],
  'room.roundNow': ['{n}라운드', 'Round {n}'],
  ...
  'room.sessions.reopenShort': ['이 회의 다시 열기', 'Reopen this meeting'],
  'room.sessions.switch': ['이 회의로 전환 — 지금 회의는 진행 중으로 보관', 'Switch to this meeting — the current one is kept in progress'],
  'room.sessions.switchShort': ['이 회의로 전환', 'Switch to this meeting'],
  'room.sessions.open': ['진행 중', 'In progress'],
  ...
  'deck.hireEx3': ['고객 문의에 답장 초안을 쓰는 CS 담당', 'A support agent who drafts replies to customer emails'],
  'room.sessions.empty': ['지난 회의가 아직 없습니다. "회의 마치기"나 "새 회의"를 누르면 여기 적재됩니다.', 'No past meetings yet. "End meeting" or "New meeting" files the room here.'],
  ...
  'room.sessions.openReadonly': ['진행 중인 회의 — 전환하면 이어서 대화합니다. 회의록은 마칠 때 남습니다.', 'Meeting in progress — switch to continue the thread. Minutes are filed when you end it.'],
  ...
  'settings.runners.deviceExpired': ['코드가 만료됐습니다 — 연결을 다시 시작해 주세요.', 'The code expired — start the connection again.'],
  'settings.runners.deviceFailed': ['연결하지 못했습니다({reason}) — 다시 시작해 주세요.', 'Could not connect ({reason}) — please start again.'],
  ...
  'settings.runners.monthTitle': ['이번 달 이 러너로 실행된 턴 수', 'Turns on this runner this month'],
  ...
  'compete.pick': ['크루', 'Crew'],
  'compete.pickModels': ['모델', 'Models'],
  ...
  'split.open': ['옆에 열기', 'Open beside'],
  'split.close': ['패널 닫기', 'Close panel'],
  'split.openCrew': ['크루를 옆에 열기', 'Open a crew beside'],
  'split.current': ['지금 보는 크루', 'Currently viewing'],
  'split.openInVault': ['기억에서 열기', 'Open in memory'],
  'split.openFull': ['전체 화면으로', 'Open full'],
  ...
  'feedback.publicNote': ['보내주신 내용은 공개 이슈 추적기에 등록됩니다. 키·비밀번호·개인정보는 적지 말아 주세요(자동 가림은 완전하지 않습니다).', 'Your report is posted to our public issue tracker. Please leave out keys, passwords, and personal details — automatic redaction is best-effort.'],
  ...
  'settings.mode.desc': ['기본 테마(그래파이트 무채색 / 아르고 다크·골드 / 리넨 웜 그레이지)와 라이트·다크·시스템 자동을 고릅니다.', 'Pick the base theme (Graphite neutral / Argo dark · gold / Linen warm greige) and light, dark, or follow the system.'],
  'settings.family': ['기본 테마', 'Base theme'],
  'settings.family.graphite': ['그래파이트', 'Graphite'],
  'settings.family.argo': ['아르고', 'Argo'],
  'settings.family.linen': ['리넨', 'Linen'],
  ...
  'settings.theme.graphite': ['그래파이트 — 무채색, 시스템 자동', 'Graphite — neutral gray, follows system'],
  'settings.theme.graphite-light': ['그래파이트 — 무채색, 밝게 고정', 'Graphite — neutral gray, always light'],
  'settings.theme.graphite-dark': ['그래파이트 — 무채색, 어둡게 고정', 'Graphite — neutral gray, always dark'],
  'settings.theme.linen': ['리넨 — 웜 그레이지·차콜 레일, 시스템 자동', 'Linen — warm greige, charcoal rail, follows system'],
  'settings.theme.linen-light': ['리넨 — 웜 그레이지, 밝게 고정', 'Linen — warm greige, always light'],
  'settings.theme.linen-dark': ['리넨 — 차콜, 어둡게 고정', 'Linen — charcoal, always dark'],
  ...
  'settings.tab.devices': ['기기·데이터', 'Devices & data'],
  'settings.tab.danger': ['위험 구역', 'Danger zone'],
  'settings.tab.label': ['설정 구획', 'Settings sections'],
  'chat.card.tab.overview': ['개요', 'Overview'],
  'chat.card.tab.ability': ['능력', 'Abilities'],
  ...
  'settings.archive.failed': ['보관을 마치지 못했습니다 — 잠시 뒤에도 목록에 남아 있으면 다시 시도해 주세요.', 'Could not finish archiving — if the company is still listed in a moment, please try again.'],
  'common.browse': ['찾아보기', 'Browse'],
  'common.noFolderChosen': ['선택된 폴더 없음', 'No folder chosen'],
  'common.pickerUnavailable': ['폴더 창을 열 수 없어 경로를 직접 입력합니다. 앱이 구버전이면 최신 버전에서 폴더 창이 열립니다.', 'Could not open the folder dialog, so type the path instead. If the app is outdated, updating restores the dialog.'],
  ...
  'settings.export.placeholder': ['내보낼 위치의 절대 경로 (예: /Volumes/T7/백업)', 'Absolute path to export to (e.g. /Volumes/T7/backup)'],
  'settings.export.run': ['내보내기', 'Export'],
  'settings.export.done': ['{n}개 파일을 내보냈습니다:', 'Exported {n} files to:'],
  'settings.export.err': ['내보내기에 실패했습니다 — 경로를 확인해 주세요', 'Export failed — please check the path'],
  'settings.export.note': ['보안을 위해 자격·연결 파일(러너 키, 메신저 봇 토큰, MCP 토큰)과 심링크(바로가기)는 내보내지 않습니다. 앱은 계속 원래 위치의 데이터를 사용합니다 — 내보낸 사본은 보관용입니다.', 'For security, credential and connection files (runner keys, messenger bot tokens, MCP tokens) and symlinks are not exported. The app keeps using the original data — the exported copy is for safekeeping.'],
  'settings.cloudExport.run': ['클라우드 자료 내보내기', 'Export Cloud Data'],
  'settings.cloudExport.hint': ['클라우드에 보존된 회사 자료 전체를 내 문서 폴더로 내려받습니다 — 결제 없이 가능하며, 자격 파일(러너 키·봇 토큰)은 제외됩니다.', 'Download all your company data preserved in the cloud to your Documents folder — no payment needed; credential files (runner keys, bot tokens) are excluded.'],
  'settings.cloudExport.done': ['{n}개 파일을 내려받았습니다:', 'Downloaded {n} files to:'],
  'settings.cloudExport.partial': ['({n}개 파일은 실패 — 다시 시도하면 새 폴더에 받습니다)', '({n} files failed — retry downloads into a new folder)'],
  'settings.cloudExport.err': ['내려받기에 실패했습니다 — 잠시 후 다시 시도해 주세요', 'Download failed — please try again shortly'],
  'settings.cloudExport.err.busy': ['이미 내려받기가 진행 중입니다', 'A download is already in progress'],
  'settings.cloudExport.err.empty': ['클라우드에 내려받을 자료가 없습니다', 'No cloud data to download'],
  'settings.cloudExport.err.no-creds': ['계정 연동이 필요합니다 — 로그인 후 다시 시도해 주세요', 'Account link required — sign in and try again'],
  'settings.cloudExport.err.copy-failed': ['내려받기 중 실패했습니다 — 네트워크와 디스크 공간을 확인해 주세요. 부분 사본은 정리했습니다', 'Download failed midway — check your network and disk space. The partial copy was cleaned up'],
  'settings.cloudExport.err.unauthorized': ['계정 연동이 필요합니다 — 로그인 후 다시 시도해 주세요', 'Account link required — sign in and try again'],
  'settings.cloudExport.err.list-failed': ['클라우드 목록 조회에 실패했습니다 — 네트워크 확인 후 다시 시도해 주세요', 'Could not list cloud data — check your network and try again'],
  'settings.cloudExport.err.exists': ['오늘 날짜의 내보내기 폴더 후보가 가득 찼습니다 — 문서 폴더의 기존 내보내기를 정리해 주세요', 'Export folder candidates for today are exhausted — clean up previous exports in your Documents folder'],
  'settings.cloudExport.err.owner-mismatch': ['이 서버의 내보내기 대상 계정이 로그인 계정과 다릅니다 — 관리자에게 문의해 주세요', 'This server\'s export account differs from your signed-in account — contact your administrator'],
  'settings.import.title': ['옵시디언에서 가져오기', 'Import from Obsidian'],
  'settings.import.desc': ['옵시디언 볼트 폴더를 고르면 노트를 Argo 기억 구조에 맞게 재분류해 복사합니다 — 데일리 노트는 일지로, 노트는 주제 노트로, 이미지·PDF는 첨부로. 원본 볼트는 절대 수정하지 않습니다.', "Pick an Obsidian vault folder and its notes are re-filed into Argo's memory structure — daily notes become journal entries, notes become topic notes, images and PDFs become files. Your vault is never modified."],
  'settings.import.placeholder': ['옵시디언 볼트의 절대 경로 (예: /Users/me/Documents/MyVault)', 'Absolute path to your Obsidian vault (e.g. /Users/me/Documents/MyVault)'],
  'settings.import.pickTitle': ['옵시디언 볼트 폴더 선택', 'Choose your Obsidian vault folder'],
  'settings.import.preview': ['미리보기', 'Preview'],
  'settings.import.run': ['가져오기', 'Import'],
  'settings.import.plan': ['가져올 항목 — 일지 {j} · 주제 노트 {n} · 첨부 {f} · 미분류 {u} · 건너뜀 {s} · 이미 가져옴 {a}', 'To import — journal {j} · topic notes {n} · files {f} · unsorted {u} · skipped {s} · already imported {a}'],
  'settings.import.planGo': ['이대로 가져올까요? 원본 볼트는 그대로 두고 복사만 하며, 기존 회사 기억을 덮지 않습니다.', 'Import now? Your vault stays untouched — files are copied, and existing company memory is never overwritten.'],
  'settings.import.progress': ['복사 중 — {done}/{total}', 'Copying — {done}/{total}'],
  'settings.import.done': ['가져오기 완료 — 일지 {j} · 주제 노트 {n} · 첨부 {f}', 'Import complete — journal {j} · topic notes {n} · files {f}'],
  'settings.import.unsorted': ['분류하지 못한 {n}건은 vault/_imported/unsorted/ 에 원본 그대로 보관했습니다:', "{n} items couldn't be classified and were kept as-is under vault/_imported/unsorted/:"],
  'settings.import.unsortedMore': ['외 {n}건 — 상세는 리포트 파일에 있습니다', '{n} more — see the report file for details'],
  ...
  'settings.import.reason.too-large': ['200MB 초과 — 복사 안 함(원본은 볼트에 그대로)', 'over 200MB — not copied (stays in your vault)'],
  'settings.import.reason.symlink': ['심링크(바로가기) — 복사 안 함', 'symlink — not copied'],
  'settings.import.reason.sensitive': ['Argo 제어파일과 같은 이름 — 복사 안 함', 'same name as an Argo control file — not copied'],
  'settings.import.reason.user-deleted': ['이전에 가져왔다가 앱에서 삭제한 항목 — 되살리지 않음', 'imported before and deleted in the app — not resurrected'],
  'settings.import.reason.ambiguous-link': ['같은 이름의 노트 여러 개 — 링크는 먼저 배치된 쪽으로', 'duplicate note names — links point to the first one'],
  'settings.workroots.err.exists': ['같은 이름의 내보내기 폴더가 이미 있습니다 — 잠시 후 다시 시도해 주세요', 'An export folder with that name already exists — try again in a moment'],
  'settings.workroots.err.copy-failed': ['복사 중 실패했습니다 — 대상 드라이브의 공간·권한을 확인해 주세요. 부분 사본은 정리했습니다', 'Copy failed midway — check free space and permissions on the target drive. The partial copy was cleaned up'],
  ...
  'settings.workroots.desc': ['크루가 회사 폴더 밖에서 일할 폴더를 지정합니다. 지정한 폴더는 크루가 우선적으로 안내받아 바로 읽고 쓰며, Gemini·Antigravity 크루의 파일 도구 반경에도 더해집니다. 경로는 기기마다 달라 이 컴퓨터에만 적용됩니다.', 'Point crews at folders outside the company workspace. Assigned folders are surfaced to crews and immediately readable and writable, and are added to Gemini·Antigravity crews’ file-tool scope. Paths are per-device, so this applies to this computer only.'],
  ...
  'settings.workroots.runnerNote': ['Claude·GLM·Kimi·Grok 크루는 도구 게이트가 폴더 단위로 적용하고, Argo 앱·자격 폴더는 항상 차단합니다. Codex 크루는 별도 격리 없이 이 컴퓨터 전체를 읽고 쓸 수 있습니다 — 여기 지정한 폴더는 크루에게 우선 안내되는 작업 위치입니다. Gemini·Antigravity 크루는 파일 도구의 반경이 회사 폴더 + 지정 폴더로 제한되지만, 셸 명령은 그 밖에 닿을 수 있고 구버전 Gemini CLI는 벤더 제한으로 지정 폴더 확장이 무시될 수 있습니다.', 'For Claude·GLM·Kimi·Grok crews the tool gate applies per folder and always blocks the Argo app and credential folders. Codex crews run without process isolation and can read and write anywhere on this computer — folders assigned here are surfaced to them as preferred work locations. Gemini·Antigravity crews have their file tools scoped to the company folder plus assigned folders, but shell commands can reach beyond that, and older Gemini CLI builds may ignore the expansion entirely (a vendor limit).'],
  ...
  'settings.workroots.err.not-found': ['이 컴퓨터에 없는 경로입니다', 'That path does not exist on this computer'],
  'settings.workroots.err.not-dir': ['폴더가 아닙니다 — 파일이 아닌 폴더를 지정해 주세요', 'Not a folder — choose a directory, not a file'],
  'settings.workroots.err.too-broad': ['디스크 전체는 지정할 수 없습니다 — 하위 폴더를 지정해 주세요', 'A whole drive can\'t be assigned — pick a subfolder'],
  ...
  'settings.caps.desc': ['끄면 크루는 회사 폴더 안에서만 일합니다. 켠 능력의 범위는 결재 없이 실행되고, 이메일 발송·게시·구매·삭제처럼 사람이 판단해야 하는 일은 어떤 설정에서도 결재함과 메신저 버튼으로 승인을 받아야 이어집니다.', 'When off, crew work only inside the company folder. Capabilities you turn on run without approval, while actions needing your judgment — sending email, publishing, purchases, deletions — always wait for approval via the inbox or messenger buttons.'],
  ...
  'topbar.updateWeb': ['새 버전 v{v}', 'New v{v}'],
  'topbar.updateWebTitle': ['새 버전 v{v} 발행됨 — 릴리스 페이지 열기(웹 버전은 자동 설치가 없습니다)', 'New v{v} released — open the release page (web has no auto-install)'],
  ...
  'settings.runners.help': ['크루의 두뇌 엔진을 회사 계정에 연결합니다. 러너마다 API 키·OAuth(구독)로 연결하거나, Codex·Antigravity는 "이 컴퓨터 로그인 사용"으로 이 컴퓨터의 CLI 로그인을 연결할 수 있습니다(Antigravity는 자격이 OS 키링에 있어 이 방식이 유일합니다). 연결한 러너만 크루가 사용합니다.', 'Connect each crew brain engine to this company. Add an API key or OAuth (subscription) per runner — for Codex and Antigravity you can also link this computer\u2019s CLI login (for Antigravity, whose credentials live in the OS keyring, this is the only path). Crews only use runners you connect.'],
  ...
  'settings.runners.setupOpenLink': ['브라우저가 안 열렸나요? 이 링크로 로그인', "Browser didn't open? Sign in via this link"],
  'settings.runners.setupCodeHint': ['브라우저에서 승인하면 코드가 표시됩니다 — 그 코드를 아래에 붙여넣으세요.', 'After you approve in the browser, a code is shown — paste it below.'],
  'settings.runners.setupCodePh': ['브라우저에 표시된 코드 붙여넣기', 'Paste the code shown in the browser'],
  'settings.runners.setupCodeSubmit': ['확인', 'Submit'],
  ...
  'settings.runners.hostNeedInstall': ['이 컴퓨터에서 CLI가 감지되지 않았습니다 — 설치하면 이 컴퓨터 로그인으로 연결할 수 있어요.', 'CLI not detected on this computer — install it to connect with this computer\u2019s login.'],
  'settings.runners.hostInstallGuide': ['설치 안내', 'Install guide'],
  'settings.runners.hostNeedLogin': ['CLI는 설치돼 있지만 로그인돼 있지 않습니다 — 터미널에서 {runner} 로그인 후 이 화면을 다시 열어 주세요.', 'The CLI is installed but not signed in — sign in to {runner} in a terminal, then reopen this screen.'],
  ...
  'settings.runners.cliToolsNote': ['쪽지·루틴 예약·결재·외부 서비스 사용: 지원(답변 뒤 처리). 동료 답을 기다리는 위임·도구 설치·장시간 작업·크루 영입·루틴 취소는 이 연결 방식에서 쓸 수 없습니다(Claude·Codex·GLM·Kimi·OpenRouter·Grok 크루는 모두 지원).', 'Mail, routine scheduling, approvals and connected services: supported (handled after the reply). Delegation that waits for a colleague, tool installs, long-running jobs, hiring crew and cancelling routines are not available with this connection (Claude, Codex, GLM, Kimi, OpenRouter and Grok crews support them all).'],
  'settings.runners.retiredNote': ['더 이상 제공되지 않는 러너입니다. 저장된 연결은 해제만 할 수 있고, 이 러너로 지정된 크루는 그대로 동작합니다 — 같은 구글 모델은 Antigravity로 쓰세요.', 'This runner is no longer offered. The saved connection can only be removed; crews already set to it keep working — use Antigravity for the same Google models.'],
  ...
  'settings.runners.removeFailed': ['연결을 해제하지 못했습니다 — 잠시 후 다시 시도해 주세요.', 'Could not disconnect — please try again shortly.'],
  ...
  // 문구는 코드가 실제 보장하는 것에만(분리 검수 2026-08-29 HIGH-2): 호스티드는 자격을 **새로** 올리지
  // 않는다(free는 cycle 스킵, pro는 noSecrets 강제). 과거 사본 회수는 pro·체험 한정(free는 RLS로 보류).
  // 워커 언급 제거 — 워커는 위임 모델(자격 접근이 목적)이라 "새 기기와 동일"이 아니다(포인트 3).
  'settings.sync.credHostedNote': ['자격 증명(러너 로그인 토큰·API 키, 텔레그램·슬랙 봇 토큰, MCP 환경변수)은 이 기기에만 저장되고 Argo 클라우드로 올라가지 않습니다 — 새로 저장되는 자격은 운영자를 포함해 본인 외에는 접근할 수 없습니다. 회사 데이터(기억·대화·크루)만 암호화되어 동기화됩니다. 과거 버전에서 올라간 사본이 있으면 다음 동기화에 회수됩니다(무료 플랜은 클라우드 쓰기 제약으로 보류되고, Pro·체험이 되면 실행됩니다). 새 기기에서는 러너·봇을 다시 연결해야 합니다.', 'Credentials (runner login tokens and API keys, Telegram/Slack bot tokens, MCP env vars) stay on this device only and are not uploaded to Argo cloud — newly saved credentials are reachable by no one but you, operator included. Only company data (memory, chats, crew) is synced, encrypted. Any copy uploaded by an older version is withdrawn on the next sync (on the free plan this is deferred by a cloud-write restriction and runs once you are on Pro/trial). New devices must reconnect runners and bots.'],
  ...
  // 팀 메신저 — 조직에 크루 등록(파견) 카드. 조직·채널·메시지는 메신저 앱이 다루고, 아르고 앱은 "내 크루를 어느 조직에 내보내나"만.
  'role.owner': ['소유자', 'Owner'],
  'role.admin': ['관리자', 'Admin'],
  'role.member': ['멤버', 'Member'],
  'role.guest': ['게스트', 'Guest'],
  'settings.msgr.title': ['Argo 메신저 연결', 'Argo Messenger connection'],
  'settings.msgr.downloadHelp': ['팀원 각자가 키운 크루를 한 조직 채널에 데려와, 사람과 크루가 같은 대화에서 일하고 결재받는 데스크톱 팀 메신저입니다. Argo 계정으로 로그인하고 초대 링크로 조직에 들어갑니다.', 'A desktop team messenger where everyone brings the crews they trained into one org channel — people and crews work and get approvals in the same conversation. Sign in with your Argo account and join an org via invite link.'],
  'settings.msgr.silicon': ['macOS · Apple Silicon', 'macOS · Apple Silicon'],
  'settings.msgr.intel': ['macOS · Intel', 'macOS · Intel'],
  'settings.msgr.win': ['Windows', 'Windows'],
  'settings.msgr.all': ['모든 릴리스', 'All releases'],
  'settings.msgr.help': ['조직을 고른 뒤 이 컴퓨터의 크루를 연결하면 팀 메신저에서 쓸 수 있습니다. 조직 채널에서 @로 부르면 연결한 크루가 해당 대화에서 답합니다.', 'Choose an organization and connect this computer’s crews to use them in the team messenger. Mention a connected crew with @ in an org channel and it replies in that conversation.'],
  'settings.msgr.notSignedIn': ['이 기기가 아르고 계정에 로그인되어 있지 않습니다. 설정의 기기 카드에서 로그인하세요.', 'This device is not signed in to an Argo account. Sign in from the Devices card.'],
  'settings.msgr.noOrg': ['가입한 조직이 없습니다. 팀 메신저 앱에서 조직을 만들거나 초대 링크로 들어온 뒤 다시 여세요.', 'You are not in any organization yet. Create one or join with an invite link in the team messenger, then come back.'],
  ...
  'settings.msgr.allow': ['누가 시킬 수 있나', 'Who can task it'],
  'settings.msgr.allow.all': ['조직 전원', 'Everyone'],
  ...
  'settings.msgr.policy': ['조직 정책', 'Organization policy'],
  'settings.msgr.policy.summary': ['허용 범위 기본값 {allow} · 고위험 결재 {approver} · 채널 크루 기억 {memory}. 잠긴 항목은 관리자가 메신저 설정에서 바꿉니다.', 'Default access {allow} · high-risk approvals by {approver} · channel crew memory {memory}. Locked items are changed by admins in the messenger settings.'],
  'settings.msgr.policy.locked': ['(잠김)', ' (locked)'],
  'settings.msgr.policy.approver.admin': ['조직 관리자', 'org admins'],
  'settings.msgr.policy.approver.owner': ['크루 소유자', 'the crew owner'],
  'settings.msgr.policy.memory.on': ['남김', 'on'],
  'settings.msgr.policy.memory.off': ['안 남김', 'off'],
  'settings.msgr.tierNote': ['파견한 크루는 조직에서 "개인 크루"로 보입니다. 조직은 이 컴퓨터의 실행 환경(모델·로컬 기록)을 통제하지 않으며, 서버가 검증하는 항목(허용 범위·답글·결재권·채널 정책)만 강제됩니다. 조직이 완전히 통제하는 크루는 회사 노드의 회사 크루입니다.', 'Dispatched crews appear as "personal crews" in the organization. The organization does not control this computer’s runtime (model, local records); only server-verified items (access, replies, approval rights, channel policy) are enforced. Crews the organization fully controls are company crews on the company node.'],
  ...
  'settings.msgr.count': ['{n} / {total} 파견 중', '{n} / {total} registered'],
  'settings.msgr.connection.title': ['이 조직에 메신저 연결', 'Connect this organization to Messenger'],
  'settings.msgr.connection.empty': ['아직 연결된 크루가 없습니다. 연결하면 이 컴퓨터의 크루가 이 조직에서 @ 멘션을 받을 수 있습니다.', 'No crews are connected yet. Connecting lets this computer’s crews receive @ mentions in this organization.'],
  'settings.msgr.connection.partial': ['크루 {n}명은 이미 연결되어 있습니다. 아직 연결되지 않은 크루를 추가할 수 있습니다.', '{n} crews are already connected. You can add the crews that are not connected yet.'],
  'settings.msgr.connection.channelNote': ['이 수는 조직에 연결된 크루 수입니다. 실제 채널 참여는 팀 메신저에서 채널마다 선택합니다.', 'This is the number of crews connected to the organization. Channel membership is chosen per channel in the team messenger.'],
  'settings.msgr.connection.activate': ['크루 {n}명 연결', 'Connect {n} crews'],
  'settings.msgr.connection.addMissing': ['연결 안 된 크루 추가', 'Add unconnected crews'],
  'settings.msgr.connection.connected': ['크루 연결됨', 'Crews connected'],
  'settings.msgr.connection.notConnected': ['연결 필요', 'Connection needed'],
  'settings.msgr.connection.statusHelp': ['현재 선택한 조직에 연결된 크루: {n}명. 이 표시는 브리지 프로세스의 실행 상태는 확인하지 않습니다.', '{n} crews are connected to the selected organization. This does not verify that the bridge process is running.'],
  'settings.msgr.roster.title': ['연결된 크루 보기', 'View connected crews'],
  'settings.msgr.roster.help': ['이 컴퓨터의 크루와 조직 연결 상태를 한눈에 확인합니다.', 'Review each crew on this computer and its connection state for this organization.'],
  'settings.msgr.err.activate': ['크루를 연결하지 못했습니다. 잠시 뒤 다시 시도하세요.', 'Could not connect crews. Try again shortly.'],
  'settings.msgr.err.reconnect': ['메신저 재연결을 시작하지 못했습니다. 잠시 뒤 다시 시도하세요.', 'Could not start reconnecting Messenger. Try again shortly.'],
  ...
  'settings.msgr.runtime.company': ['회사 설정을 읽지 못해 메신저를 시작하지 못했습니다. 다시 연결을 시도하세요.', 'Messenger could not start because company settings could not be read. Try reconnecting.'],
  'settings.msgr.runtime.noCrews': ['연결된 크루가 없습니다. 아래에서 크루를 연결하세요.', 'There are no connected crew members. Connect a crew below.'],
  'settings.msgr.runtime.reconnecting': ['메신저에 다시 연결하는 중입니다.', 'Reconnecting Messenger.'],
  'settings.msgr.runtime.reconnect': ['다시 연결', 'Reconnect'],
  'settings.msgr.expand': ['허용 범위 펼치기', 'Show access settings'],
  'settings.msgr.fine.summary': ['결재·허용 범위·개인 크루의 한계', 'Approvals, access scope, and personal-crew limits'],
  'settings.msgr.err.load': ['조직·등록 상태를 불러오지 못했습니다.', 'Could not load organizations and registrations.'],
  'settings.notify.title': ['알림 받을 메신저', 'Where to receive crew notifications'],
  'settings.notify.help': ['체크한 메신저로 크루 알림(결재 요청·작업 완료·쪽지·루틴 결과)을 받습니다. 연결된 메신저만 켤 수 있고, 여러 개를 켜면 모두에 갑니다.', 'Crew notifications (approval requests, task results, crew mail, routine results) go to every messenger you check. Only connected messengers can be turned on; check several to receive on all of them.'],
  'settings.notify.ch.msgr': ['아르고 메신저', 'Argo Messenger'],
  'settings.notify.ch.telegram': ['텔레그램', 'Telegram'],
  'settings.notify.ch.slack': ['슬랙', 'Slack'],
  'settings.notify.why.msgrLogin': ['아르고 계정 로그인 필요', 'Sign in to Argo first'],
  'settings.notify.why.msgrBridge': ['파견된 크루 없음', 'No crew dispatched'],
  'settings.notify.why.notConnected': ['연결 안 됨', 'Not connected'],
  'settings.notify.err.save': ['설정을 저장하지 못했습니다. 잠시 뒤 다시 시도하세요.', 'Could not save. Try again shortly.'],
  'settings.msgr.exceptions': ['예외 {n}', '{n} exceptions'],
  ...
  'settings.connectors.empty': ['아직 연결할 수 있는 서비스가 없습니다.', 'No services available to connect yet.'],
  'settings.connectors.connect': ['연결', 'Connect'],
  'settings.connectors.reconnect': ['다시 연결', 'Reconnect'],
  ...
  'login.subtitle': [
    'Google·GitHub으로 시작하면 로그인 한 번으로 기억이 기기 간에 동기화됩니다. 이 컴퓨터에서만 쓰시려면 로컬 전용으로 시작하세요.',
    'Start with Google or GitHub — one sign-in keeps your memory in sync across devices. Or start local-only on this computer.',
  ],
  'login.or': ['또는', 'or'],
  'login.google': ['Google로 계속하기', 'Continue with Google'],
  'login.github': ['GitHub로 계속하기', 'Continue with GitHub'],
  'login.guestBtn': ['로컬 전용으로 시작', 'Start local-only'],
  'home.localOnly': ['로컬 전용', 'Local-only'],
  'home.claimBanner': ['이 컴퓨터에 계정 미연결 회사 {n}개가 있습니다 — 연결하면 기기 간 동기화가 시작됩니다.', 'This computer has {n} companies not linked to your account — attach them to start syncing across devices.'],
  'home.claimBtn': ['이 계정에 연결', 'Attach to this account'],
  'home.claimConfirmTitle': ['회사를 계정에 연결', 'Attach companies to your account'],
  'home.claimConfirm': ['{names} — 이 회사들을 {email} 계정에 연결하고 동기화를 시작합니다. 기억·크루·대화가 계정을 따라다니게 됩니다.', '{names} — attach these companies to {email} and start syncing. Memory, crew and conversations will follow your account.'],
  'login.guestNote': [
    '로그인 없이 이 컴퓨터에서만 사용합니다. 나중에 로그인하면 만든 회사를 계정에 연결해 동기화할 수 있어요.',
    'Use Argo on this computer only, no account needed. Sign in later to attach your companies to an account and sync.',
  ],
  ...
  'deck.save': ['저장', 'Save'],
  'deck.saveHint': ['기록·기억 그래프의 과거 흔적은 그대로 유지됩니다', 'Past records and memory-graph traces are preserved'],
  ...
  'deck.limit.title': ['사용 한도', 'usage limit'],
  'deck.limit.hours': ['{n}시간', '{n}h'],
  'deck.limit.days': ['{n}일', '{n}d'],
  'deck.limit.resetDH': ['리셋 {d}일 {h}시간 후', 'resets in {d}d {h}h'],
  'deck.limit.resetHM': ['리셋 {h}시간 {m}분 후', 'resets in {h}h {m}m'],
  'deck.limit.resetM': ['리셋 {m}분 후', 'resets in {m}m'],
  'deck.limit.stale': ['{n}시간 전 기준', 'as of {n}h ago'],
  ...
  'vault.export.docx': ['워드 문서로 내려받기 (제목·문단·표)', 'Download as Word (headings, paragraphs, tables)'],
  'vault.export.xlsx': ['엑셀로 내려받기 (표마다 시트 하나)', 'Download as Excel (one sheet per table)'],
  'vault.export.csv': ['CSV로 내려받기 (표만)', 'Download as CSV (tables only)'],
  ...
  'vault.sortTime': ['수정 시각순 (클릭: 이름순)', 'Sorted by modified (click: by name)'],
  'vault.sortName': ['이름순 (클릭: 수정 시각순)', 'Sorted by name (click: by modified)'],
  'vault.collapseAll': ['모두 접기', 'Collapse all'],
  'vault.toggleSearch': ['검색', 'Search'],
  ...
  'chat.ruleSuggest.notice': ['같은 지적이 {n}번 반복됐어요 — 회사 규칙으로 기억할까요?', 'The same correction came up {n} times — make it a company rule?'],
  'chat.ruleSuggest.adopt': ['규칙으로 기억', 'Remember as rule'],
  'chat.ruleSuggest.dismiss': ['넘기기', 'Skip'],
  'chat.card': ['카드', 'Card'],
  'chat.commands': ['명령', 'Commands'],
  'chat.cmd.skills': ['스킬', 'Skill'],
  'chat.cmd.aliases': ['별칭', 'Alias'],
  'chat.cmd.skillPrefix': ['"{name}" 스킬을 사용해서 ', 'Use the "{name}" skill to '],
  'chat.cmd.aliasAdd': ['별칭 등록 — 자주 쓰는 지시를 /명령으로', 'Register alias — save a prompt as /command'],
  'chat.cmd.aliasDelete': ['별칭 삭제', 'Delete alias'],
  'chat.cmd.aliasName': ['명령 이름', 'Command name'],
  'chat.cmd.aliasNamePh': ['예: 보고서', 'e.g. report'],
  ...
  'chat.fail.quota': ['사용 한도 또는 잔액이 소진됐습니다 — 잠시 뒤 다시 보내거나 다른 러너를 지정해 주세요. ({msg})', 'Usage limit or balance exhausted — try again later or assign another runner. ({msg})'],
  ...
  'activity.shellFallbackChip': ['셸 폴백', 'Shell fallback'],
  ...
  'chat.card.rulesHint': ['규칙을 누르면 고치고, 크루에게 "카드의 N번 규칙을 ~로 바꿔"라고 말해도 됩니다(결재 뒤 적용).', 'Click a rule to edit it, or tell the crew "change rule N to …" (applied after approval).'],
  ...
  'chat.card.ruleEdit': ['눌러서 고치기', 'Click to edit'],
  'chat.card.ruleDelete': ['삭제', 'Delete'],
  'chat.card.ruleUp': ['위로', 'Move up'],
  'chat.card.ruleDown': ['아래로', 'Move down'],
  ...
  'chat.tg.otherDevice': ['다른 기기({device})에서 수신 중', 'Receiving on {device}'],
  ...
  'chat.preview': ['미리보기', 'Preview'],
  'chat.preview.close': ['미리보기 접기', 'Hide preview'],
  'chat.preview.unsupported': ['이 형식은 미리보기를 지원하지 않습니다 — 다운로드로 확인해 주세요', 'Preview not available for this format — download to view'],
  'chat.preview.truncated': ['내용이 길어 앞부분만 표시합니다', 'Long file — showing the beginning only'],
  'chat.preview.error': ['미리보기를 불러오지 못했습니다', 'Could not load the preview'],
  ...
  'routines.scheduleInterval': ['{min}분마다', 'Every {min} min'],
  ...
  'routines.interval': ['N분마다', 'Every N min'],
  'routines.intervalEvery': ['반복 간격(분)', 'Interval (min)'],
  'routines.nlPlaceholder': ['말로 쓰면 자동 설정 — 예: 평일 아침 9시랑 오후 6시에 인스타 댓글 확인하고 정리해줘', 'Describe it and auto-fill — e.g. Weekdays at 9am and 6pm, check and summarize Instagram comments'],
  'routines.nlApply': ['자동 설정', 'Auto-fill'],
  ...
  'routines.editAria': ['루틴 수정', 'Edit routine'],
  'routines.saveFail': ['저장에 실패했습니다', 'Failed to save'],
  'routines.notifications.delivery': ['최근 알림 전달 상태', 'Latest notification delivery'],
  'routines.notifications.status.sent': ['전달됨', 'Delivered'],
  'routines.notifications.status.muted': ['알림 꺼짐', 'Muted'],
  'routines.notifications.status.unavailable': ['연결 확인 필요', 'Check connection'],
  'routines.notifications.status.failed': ['전달 실패', 'Delivery failed'],
  'routines.notifications.status.uncertain': ['전달 여부 확인 필요', 'Delivery unconfirmed'],
  'routines.notifications.label': ["알림 받을 곳", "Notify me in"],
  'routines.notifications.hint': ["프롬프트에는 업무와 시간을 적고, 결과를 받을 채널은 여기서 여러 개 선택하세요.", "Describe the work and time in the prompt. Select one or more channels here to receive the result."],
  'routines.notifications.legacy': ["현재 연결 설정 사용", "Use current connection settings"],
  'routines.notifications.choose': ["알림 받을 곳 선택", "Choose notification destinations"],
  'routines.notifications.telegram': ["텔레그램", "Telegram"],
  'routines.notifications.slack': ["슬랙", "Slack"],
  'routines.notifications.msgr': ["Argo 메신저", "Argo Messenger"],
  'routines.notifications.none': ["채널 알림 안 받기", "No channel notifications"],
  'routines.notifications.room': ["메신저 대화방", "Messenger conversation"],
  'routines.notifications.roomPlaceholder': ["알림 받을 대화방을 선택하세요", "Choose a conversation for notifications"],
  'routines.notifications.roomUnavailable': ["기존 대화방 · 현재 사용 불가", "Saved conversation · currently unavailable"],
  'routines.notifications.roomUnavailableHint': ["이 크루가 알림을 보낼 수 있는 대화방을 다시 선택하세요. 기존 선택은 자동으로 바뀌지 않습니다.", "Choose a conversation this crew can notify. Your saved selection has not been replaced."],
  'routines.notifications.muted': ["연결 설정에서 루틴 알림이 꺼져 있습니다", "Routine notifications are muted in connection settings"],
  'routines.notifications.not_owned': ["내가 소유한 크루에서 설정할 수 있습니다", "Available for crews you own"],
  'routines.notifications.no_channels': ["이 크루가 알림을 보낼 대화방이 없습니다", "No available conversation for this crew"],
  'routines.notifications.unavailable': ["연결 상태를 확인하세요", "Check this connection"],
  'routines.notifications.saveFail': ['알림 받을 곳을 저장하지 못했습니다. 선택한 채널의 연결·알림 설정과 대화방 접근 권한을 확인하세요.', 'Could not save notification destinations. Check the selected channels’ connections, notification settings, and conversation access.'],
  'routines.notifications.loadFail': ["알림 연결을 불러오지 못했습니다. 선택한 알림 설정은 유지됩니다.", "Could not load notification connections. Your selection is unchanged."],
  'routines.notifications.retry': ["다시 불러오기", "Try again"],
  'routines.notifications.without': ["채널 알림 없이 설정", "Set up without channel notifications"],
  'routines.notifications.loading': ["알림 연결 확인 중…", "Checking notification connections…"],
  'routines.notifications.history': ["실행 결과는 루틴 기록에 남습니다. 선택한 채널의 연결 설정에서 루틴 알림을 끄면 해당 채널에는 전송되지 않습니다.", "Results remain in routine history. Muting routine notifications in a selected channel’s connection settings stops delivery to that channel."],
  ...
  'routines.verify.label': ['완료 조건 (선택)', 'Completion check (optional)'],
  'routines.verify.hint': ['지정한 파일이 회사 기억에 실제로 생겨야 완료로 칩니다. 미충족이면 크루가 자동 재시도하고, 끝내 못 채우면 실패로 표시됩니다.', 'The routine only counts as done when these files actually exist in company memory. If not, the crew retries automatically; if still unmet, the run is marked failed.'],
  ...
  'routines.loop.progress': ['{runs}/{max}회', '{runs}/{max} runs'],
  ...
  'market.skillInvalidId': ['스킬 이름이 올바르지 않습니다.', 'The skill ID is invalid.'],
  'market.skillInvalidDirectory': ['스킬 폴더가 올바르지 않아 삭제하지 않았습니다.', 'The skills directory is invalid. Nothing was removed.'],
  'market.skillAmbiguous': ['같은 이름의 스킬 파일과 폴더가 함께 있어 삭제하지 않았습니다.', 'A skill file and folder share this ID. Nothing was removed.'],
  'market.skillInvalidPackage': ['스킬 폴더의 구조가 올바르지 않아 삭제하지 않았습니다.', 'The skill package is invalid. Nothing was removed.'],
  'market.mcpReadFailed': ['MCP 설정을 읽을 수 없습니다. 기존 파일은 그대로 보존했습니다.', 'MCP settings could not be read. The existing file was preserved.'],
  'market.mcpInvalidConfig': ['MCP 설정 형식이 올바르지 않습니다. 기존 파일은 그대로 보존했습니다.', 'MCP settings have an invalid format. The existing file was preserved.'],
  ...
  'market.skillRefBadge': ['참조만 주입(예산 초과)', 'Reference only (over budget)'],
  'market.skillRefHint': ['스킬 전문 주입 예산(총 6,000자)을 넘어 본문 대신 "필요할 때 skills/ 파일을 읽어라"는 참조 한 줄만 들어갑니다. 요약을 만드는 것이 아닙니다. 자주 쓰는 스킬이면 내용을 줄이면 전문이 주입됩니다.', 'This skill is large, so a reference is injected instead of the full text — crews open the skills/ file when relevant. Shorten it if you want the full text always injected.'],
  ...
  'chat.card.mcpCliWarn': ['이 크루의 러너(Antigravity)에서는 MCP 도구가 아직 실행되지 않습니다 — Codex나 SDK 러너로 바꾸면 사용됩니다.', 'MCP tools do not run on this crew\'s runner (Antigravity) yet — switch to Codex or an SDK runner to use them.'],
  'market.mcpRunnerNote': ['Antigravity 크루는 아직 MCP를 쓸 수 없습니다 — Codex와 SDK 러너(Claude·GLM·Kimi·OpenRouter·Grok) 크루에서 사용됩니다.', 'Crews on Antigravity cannot use MCP yet — it runs on Codex and SDK-runner crews (Claude·GLM·Kimi·OpenRouter·Grok).'],
