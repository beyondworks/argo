...
const DICT = {
  ...
  'market.mcpRunnerNote': ['Antigravity 크루는 아직 MCP를 쓸 수 없습니다 — Codex·Gemini와 SDK 러너(Claude·GLM·Kimi·OpenRouter·Grok) 크루에서 사용됩니다.', 'Crews on Antigravity cannot use MCP yet — it runs on Codex, Gemini, and SDK-runner crews (Claude·GLM·Kimi·OpenRouter·Grok).'],
