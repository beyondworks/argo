...
const DICT = {
  ...
  'localImport.title': ["이 기기의 자산 가져오기", "Import assets from this device"],
  'localImport.offer': ["기존 도구의 직원·스킬·도구·기억을 새 회사로 가져올 수 있습니다.", "Bring employees, skills, tools, and memories from your existing tools into the new company."],
  ...
  'localImport.description': ["원본과 기존 회사 자료를 덮어쓰지 않고 선택한 항목을 복사합니다. 도구 실행이나 연결 성공을 확인하는 작업은 아닙니다.", "Copy selected assets without overwriting originals or existing company data. This does not execute tools or verify their connections."],
  ...
  'settings.msgr.title': ['팀 메신저에 크루 등록', 'Register crews to team messenger'],
  'settings.msgr.help': ['내 크루를 팀 메신저의 조직에 파견합니다. 조직 채널에서 @로 부르면 이 컴퓨터의 크루가 답합니다. 크루는 계속 이 회사 소속이고 열쇠도 이 컴퓨터에만 있습니다.', 'Send your crews to a team-messenger organization. When mentioned in an org channel, the crew answers from this computer. The crew stays in this company and its keys stay here.'],
  ...
  'settings.msgr.registered': ['파견 중', 'Registered'],
  'settings.msgr.notRegistered': ['미등록', 'Not registered'],
  ...
  'market.appsSectionTitle': ['앱 — Argo 메신저', 'Apps — Argo Messenger'],
  'market.msgr.desc': ['팀원 각자가 키운 크루를 한 조직 채널에 데려와, 사람과 크루가 같은 대화에서 일하고 결재받는 데스크톱 팀 메신저입니다. Argo 계정으로 로그인하고 초대 링크로 조직에 들어갑니다.', 'A desktop team messenger where everyone brings the crews they trained into one org channel — people and crews work and get approvals in the same conversation. Sign in with your Argo account and join an org via invite link.'],
  'market.msgr.silicon': ['macOS · Apple Silicon', 'macOS · Apple Silicon'],
  'market.msgr.intel': ['macOS · Intel', 'macOS · Intel'],
  'market.msgr.win': ['Windows', 'Windows'],
  'market.msgr.all': ['모든 릴리스', 'All releases'],
  'market.msgr.dispatchHint': ['크루 파견: 설정 → 연결 → 팀 메신저에 크루 등록', 'Dispatch crews: Settings → Connections → Register crews to team messenger'],
