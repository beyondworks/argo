...
const DICT = {
  ...
  'settings.caps.fsRoots.title': ['허용 폴더', 'Allowed folders'],
  'settings.caps.fsRoots.desc': ['홈 폴더 밖에서 크루가 읽고 쓸 수 있는 폴더를 추가합니다(외장 SSD·다른 드라이브의 프로젝트 폴더 등). 앱 설치 폴더와 Argo 데이터 폴더는 지정할 수 없습니다.', 'Folders outside your home that crews may read and write (external SSD, project folders on other drives). The app install folder and Argo data folder cannot be added.'],
  'settings.caps.fsRoots.ph': ['/Users/me/work 또는 D:\\projects', '/Users/me/work or D:\\projects'],
