...
const DICT = {
  ...
  'settings.msgr.title': ['팀 메신저 연결', 'Team messenger link'],
  'settings.msgr.help': ['아르고에 로그인하면 이 컴퓨터의 크루 전부가 팀 메신저의 내 조직에 파견됩니다. 조직 채널에서 @로 부르면 이 컴퓨터가 답합니다.', 'Signing in to Argo dispatches every crew on this computer to your team messenger organizations. Mention them with @ in an org channel and this computer answers.'],
