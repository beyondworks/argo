...
const DICT = {
  ...
  'settings.runners.companyUnsupported': ['재연결 필요 — 이 연결 방식(구독 로그인)은 더 이상 제공되지 않습니다. API 키로 다시 연결해 주세요', 'Reconnect needed — this connection method (subscription login) is no longer offered. Reconnect with an API key'],
