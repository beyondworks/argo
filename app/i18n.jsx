...
const DICT = {
  ...
  'chat.card.mcpCliWarn': ['이 크루의 러너(Gemini·Antigravity)에서는 MCP 도구가 아직 실행되지 않습니다 — Codex나 SDK 러너로 바꾸면 사용됩니다.', 'MCP tools do not run on this crew\'s runner (Gemini·Antigravity) yet — switch to Codex or an SDK runner to use them.'],
  'market.mcpRunnerNote': ['Gemini·Antigravity 크루는 아직 MCP를 쓸 수 없습니다 — Codex와 SDK 러너(Claude·GLM·Kimi·OpenRouter·Grok) 크루에서 사용됩니다. 나머지 러너도 지원이 예정돼 있습니다.', 'Crews on Gemini or Antigravity cannot use MCP yet — it runs on Codex and SDK-runner crews (Claude·GLM·Kimi·OpenRouter·Grok). Support for the rest is planned.'],
