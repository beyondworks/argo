...
const DICT = {
  ...
  'settings.mode.desc': ['기본 테마(그래파이트 무채색 / 아르고 다크·골드)와 라이트·다크·시스템 자동을 고릅니다.', 'Pick the base theme (Graphite neutral / Argo dark · gold) and light, dark, or follow the system.'],
  ...
  // 휴대폰에서 열기(설정 카드 app/c/[ws]/mobile-card.jsx) + 폰 페어링 페이지(app/m/pair)
  'mobile.title': ['휴대폰에서 열기', 'Open on your phone'],
  'mobile.help': ['이 컴퓨터가 켜져 있는 동안, 같은 와이파이(또는 Tailscale)에 있는 휴대폰에서 아르고를 엽니다. 실행은 이 컴퓨터가 합니다.', 'While this computer is on, open Argo from a phone on the same Wi-Fi (or Tailscale). This computer does the work.'],
  ...
  'mobile.scan': ['휴대폰 카메라로 QR을 비추거나, 주소와 코드를 직접 입력하세요.', 'Scan the QR with your phone camera, or enter the address and code.'],
  'mobile.code': ['코드', 'Code'],
  'mobile.expiresIn': ['{s}초 뒤 만료', 'Expires in {s}s'],
  'mobile.expired': ['만료됨', 'Expired'],
  'mobile.newCode': ['새 코드', 'New code'],
  'mobile.paired': ['연결된 휴대폰', 'Connected phones'],
  'mobile.none': ['아직 연결된 휴대폰이 없습니다.', 'No phones connected yet.'],
  'mobile.lastSeen': ['마지막 접속 {when}', 'Last seen {when}'],
  'mobile.revoke': ['연결 해제', 'Disconnect'],
  'mobile.revokeTitle': ['이 휴대폰의 연결을 해제할까요?', 'Disconnect this phone?'],
  'mobile.revokeDesc': ['해제하면 그 휴대폰은 즉시 접근이 끊기고, 다시 쓰려면 새로 페어링해야 합니다.', 'The phone loses access immediately and must pair again to reconnect.'],
  'mobile.firewall': ['처음 켤 때 macOS·Windows 방화벽이 들어오는 연결 허용을 물으면 허용해 주세요.', 'If the macOS or Windows firewall asks to allow incoming connections the first time, allow it.'],
  'mobile.noForward': ['공유기 포트포워딩으로 인터넷에 공개하지 마세요. 밖에서는 Tailscale을 쓰세요.', 'Do not expose this port through router port forwarding. Use Tailscale from outside.'],
  'mobile.pair.title': ['PC의 아르고에 연결', 'Connect to Argo on your PC'],
  'mobile.pair.help': ['PC 설정 → 휴대폰에서 열기에 표시된 6자리 코드를 입력하세요.', 'Enter the 6-character code shown under PC settings → Open on your phone.'],
  'mobile.pair.code': ['코드', 'Code'],
  'mobile.pair.submit': ['연결', 'Connect'],
  'mobile.pair.connecting': ['연결 중…', 'Connecting…'],
  'mobile.pair.done': ['연결됐습니다. 잠시 후 이동합니다.', 'Connected. Redirecting…'],
  // 폰 셸(하단 탭·크루 목록·더보기) — data-shell="mobile"일 때만 렌더(app/c/[ws]/layout.jsx·crew/page.jsx)
  'mobile.tab.home': ['홈', 'Home'],
  'mobile.tab.crew': ['크루', 'Crew'],
  'mobile.tab.room': ['회의실', 'Room'],
  'mobile.tab.activity': ['활동', 'Activity'],
  'mobile.tab.more': ['더보기', 'More'],
  'mobile.crew.title': ['크루', 'Crew'],
  'mobile.crew.empty': ['아직 크루가 없습니다. PC에서 크루를 영입하세요.', 'No crew yet. Hire crew from the PC.'],
  'mobile.crew.approvals': ['결재 대기 {n}', '{n} pending'],
  'mobile.crew.unread': ['답변 도착', 'New reply'],
  'mobile.more.pc': ['PC 연결', 'PC connection'],
  'mobile.more.pcHint': ['PC가 켜져 있고 같은 네트워크(또는 Tailscale)에 있을 때 동작합니다.', 'Works while the PC is on and reachable on the same network (or Tailscale).'],
  'mobile.more.repair': ['다시 연결', 'Reconnect'],
