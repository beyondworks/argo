...
const DICT = {
  ...
  'runner.effortAutoHint': ['추론 강도 — Claude·Codex로 실행될 때 적용됩니다(Gemini·GLM·Kimi는 미지원)', 'Reasoning effort — applies on Claude and Codex (not supported on Gemini, GLM, Kimi)'],
