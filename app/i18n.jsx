...
const DICT = {
  ...
  'settings.notify.help': ['결재 요청·장시간 작업 완료·동료 쪽지·루틴 결과 같은 크루 알림을 어느 메신저로 받을지 고릅니다. 연결된 메신저만 켤 수 있고, 여러 개를 켜면 모두에 갑니다. 아르고 메신저는 그 크루와 나의 1:1 방으로 옵니다.', 'Choose which messengers receive crew notifications (approval requests, long task results, crew mail, routine results). Only connected messengers can be turned on; turning on several sends to all of them. Argo Messenger delivers to your 1:1 room with that crew.'],
  ...
  'settings.notify.hint': ['종류별로 골라 받으려면 아래 각 메신저 카드의 "이 채널로 보낼 알림"에서 조정하세요. 메신저 안에서 시작한 실행의 결과는 원래 방으로 갑니다.', 'To pick notification kinds per messenger, use "Send to this channel" in each card below. Results of runs started inside Messenger stay in their own room.'],
