...
export const RUNNERS = {
  ...
  openrouter: {
    ...
    models: [
      ...
      //    **첫 항목·온보딩 기본**. nemotron-3-super:free는 4회 중 2회 실패(Nvidia 업스트림) → 살려 두되 2번째.
      //    gemma-4:free는 제공사 429 2/2, inkling:free는 403(제한) → 미등재. 발행 뒤 죽으면 원격 오버레이(alias·retire)로 먼저 막고 코드는 다음 발행에.
