...
const PATHS = {
  ...
  gear: '<g transform="scale(0.6667)"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></g>', // 표준 톱니(feather settings, 16 스케일) — 옛 8각 톱니가 어색하다는 지적(유건 2026-09-09)
  clip: '<path d="m13.5 7.5-5.7 5.7a3.5 3.5 0 0 1-5-5l6-6a2.3 2.3 0 0 1 3.3 3.3L6.4 11a1.1 1.1 0 0 1-1.6-1.6l5.2-5.2"/>',
  person: '<circle cx="8" cy="5.5" r="2.7"/><path d="M2.8 14a5.2 5.2 0 0 1 10.4 0"/>', // 친구(개인 공간 홈 친구 절, 2026-09-17)
  ...
  bell: '<path d="M4 10.5V7a4 4 0 0 1 8 0v3.5l1 1.5H3z"/><path d="M6.5 13a1.5 1.5 0 0 0 3 0"/>', // 별(memory)과 같은 중심선(유건 2026-09-09: 두 아이콘 가운데가 안 맞음)
  sort: '<path d="M2.5 4h11"/><path d="M4.5 8h7"/><path d="M6.5 12h3"/>',
  belloff: '<path d="M4 10.5V7a4 4 0 0 1 8 0v3.5l1 1.5H3z"/><path d="M6.5 13a1.5 1.5 0 0 0 3 0"/><path d="M2.5 2.5l11 11" stroke="var(--bg)" stroke-width="4"/><path d="M2.5 2.5l11 11"/>',
