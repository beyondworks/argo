// 메신저 아이콘 세트 — 시안 v2(design/system-v2.css) 스프라이트 19종 그대로. 16 그리드 · 1.5px 스트로크 · 둥근 끝.
...
const PATHS = {
  ...
  folder: '<path d="M2 4.5A1.5 1.5 0 0 1 3.5 3h3l1.5 1.5h4.5A1.5 1.5 0 0 1 14 6v6a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 12z"/>',
