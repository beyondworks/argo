...
const PATHS = {
  ...
  gear: '<circle cx="8" cy="8" r="2"/><path d="M6.9 1.8h2.2l.35 1.6a5 5 0 0 1 1.3.75l1.55-.55 1.1 1.9-1.2 1.05a5 5 0 0 1 0 1.5l1.2 1.05-1.1 1.9-1.55-.55a5 5 0 0 1-1.3.75l-.35 1.6H6.9l-.35-1.6a5 5 0 0 1-1.3-.75l-1.55.55-1.1-1.9 1.2-1.05a5 5 0 0 1 0-1.5L2.6 5.5l1.1-1.9 1.55.55a5 5 0 0 1 1.3-.75z"/>', // 톱니(설정) — 옛 그림은 햇님처럼 보였다(유건 지적 2026-09-09)
