...
const state = window.__dmInviteFixture = { calls: [], failNext: null, broadcasts: {}, channelNames: [], tables: {
  ...
  msgr_crews: [
    { id: 'crew-1', org_id: org, owner_user_id: uid, slug: 'fixture-crew', display_name: 'Fixture Agent', hosting: 'local', status: 'active', last_seen_at: awayCrew ? new Date(Date.now() - 10 * 60_000).toISOString() : now, created_at: now, allow: 'all' },
  ...
  msgr_channel_members: [
    ...(awayCrew ? [{ channel_id: 'general', member_kind: 'crew', member_id: 'crew-1' }, { channel_id: 'general', member_kind: 'crew', member_id: 'crew-3' }] : []), // crew-3은 켜져 있는 대조군
