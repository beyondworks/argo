...
const state = window.__flinkFixture = { calls: [], failNext: null, broadcasts: {}, channelNames: [], tables: {
...
window.__flinkBroadcast = (event, payload) => { for (const cb of state.broadcasts[event] ?? []) cb({ payload }); };
