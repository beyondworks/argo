...
const state = window.__joinFixture = { calls: [], failNext: null, broadcasts: {}, channelNames: [], tables: {
...
window.__joinBroadcast = (event, payload) => { for (const cb of state.broadcasts[event] ?? []) cb({ payload }); };
