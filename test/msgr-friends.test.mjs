...
test('화면: 프로필 카드는 본인 upsert만 · 친구 찾기·요청·수락·거절·삭제는 전부 RPC · 레일 친구 절(같은 조직이면 DM) · 알림함에 받은 요청', () => {
  ...
  assert.match(app, /inOrg \? openDm\('user', f\.user_id\)/, '같은 조직이면 DM');
